...
<v-container>
      <v-row justify="center">
        ...
        <v-card width="65%">
          <v-img height="250px" src="https://www.beepquest.com/wp-content/uploads/2021/06/Customer-Success.png"></v-img>
        ...
        <v-card width="65%">
          <v-img height="50px" src="https://www.beepquest.com/wp-content/uploads/2021/06/Customer-Success.png"></v-img>

  
          <v-card-text>
            <div class="font-weight-bold ml-8 mb-2"><h2 align="center" justify="center">Pending Approval Funds</h2>   </div>
        ...
        <v-card width="65%">
            ...
            <v-card-text>
              <div class="font-weight-bold ml-8 mb-2"><h2 align="center" justify="center">Active Funds</h2>   </div>
